package com.example.wangchang.fulv.view.otherview;
...
import com.example.wangchang.fulv.util.DisplayTool;
...
public class PromptDialog extends Dialog {
    ...
    private void initView() {
        View contentView = View.inflate(context, R.layout.layout_promptdialog, null);
        ...
        triangleIv.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, DisplayTool.getInstance(getContext()).convertDP2PX(10)));
        triangleIv.setImageBitmap(createTriangel((int) (DisplayTool.getInstance(getContext()).getScreenSize(getContext()).x * 0.7), DisplayTool.getInstance(getContext()).convertDP2PX(10)));
        ...
        int radius = DisplayTool.getInstance(getContext()).convertDP2PX( DEFAULT_RADIUS);
    ...
    private void resizeDialog() {
        ...
        params.width = (int)(DisplayTool.getInstance(getContext()).getScreenSize(getContext()).x * 0.7);
